...
# Update Paths:
out=/data/schwartzlab/Biancani/PlacentalPolytomy/output/04_feature_assessment
wd=/data/schwartzlab/Biancani/PlacentalPolytomy/04_feature_assessment
assesser_path=$wd/scripts/assess_gene_properties.R
outfile=properties.txt
